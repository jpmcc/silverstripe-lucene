...
class ZendSearchLuceneSearchable extends DataExtension {
     ...
     * @static
     */
    protected static $extraSearchFields = ['ID', 'ClassName', 'LastEdited'];
     ...
     * @static
     */
    protected static $unstored_fields = [
     ...
     * @static
     */
    protected static $unindexed_fields = [
        'LastEdited', 'Created'
    ];
     ...
     * @static
     */
    protected static $keyword_fields = [
        'ID', 'ClassName'
    ];
    ...
    public static function enable($searchableClasses = ['SiteTree', 'File']) {
        ...
        foreach ($searchableClasses as $class) {
            if (isset(self::$defaultColumns[$class])) {
                $class::add_extension("ZendSearchLuceneSearchable('" . self::$defaultColumns[$class] . "')");
            } else {
        ...
        ContentController::add_extension('ZendSearchLuceneContentController');
        SiteConfig::add_extension('ZendSearchLuceneSiteConfig');
        LeftAndMain::add_extension('ZendSearchLuceneCMSDecorator');
        StringField::add_extension('ZendSearchLuceneTextHighlightDecorator');
